...
export function registerAnalyticsApp() {
    if (!window.Alpine) {
    ...
    window.Alpine.data('analyticsApp', () => ({
        activePeriod: (window.ANALYTICS_CONFIG && window.ANALYTICS_CONFIG.initialPeriod) ? window.ANALYTICS_CONFIG.initialPeriod : 'month',
        activeTab: 'overview',
        isLoading: false,
        lastUpdated: null,
        data: null,
