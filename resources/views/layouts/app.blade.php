...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --color-accent: #0fb9b1;
            --color-accent-soft: rgba(15, 185, 177, 0.14);
            --color-accent-dark: rgba(15, 185, 177, 0.2);
        ...
        html.dark {
            --color-bg: #061a16;
            --color-bg-soft: #0b2620;
            --color-surface: #0f2e28;
            --color-surface-soft: #143a32;
            --color-surface-strong: #18463c;
            --color-text: #e8f5f2;
            --color-text-secondary: #9db7b1;
            --color-border: rgba(255, 255, 255, 0.06);
            --color-border-strong: rgba(255, 255, 255, 0.12);
            --shadow-sm: 0 8px 24px rgba(0, 0, 0, 0.3);
            --shadow-md: 0 12px 32px rgba(0, 0, 0, 0.4);
            --shadow-lg: 0 22px 55px rgba(0, 0, 0, 0.5);
            --shadow-hover: 0 16px 40px rgba(15, 185, 177, 0.3);
        }
        ...
        * {
        ...
        .sidebar {
            ...
            height: 100vh;
            background: linear-gradient(180deg, var(--color-primary), #024c3d);
            color: white;
        ...
        .top-header .search-bar input::placeholder {
        ...
        .accent-chip:hover {
            transform: translateY(-2px);
            border-color: var(--color-accent);
            box-shadow: 0 4px 12px rgba(15, 185, 177, 0.15);
        }
        ...
        .accent-chip.active {
            ...
            color: white;
            border-color: var(--color-accent);
            box-shadow: 0 4px 12px rgba(15, 185, 177, 0.25);
        }
        ...
        .btn-primary:hover {
            background: #0a9fa0;
            transform: translateY(-2px);
            box-shadow: 0 8px 16px rgba(15, 185, 177, 0.3);
        }
