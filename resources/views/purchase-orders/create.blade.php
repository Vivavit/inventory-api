...
<div class="container-fluid">
    ...
    <div class="form-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1><i class="bi bi-plus-circle me-2"></i>Create Purchase Order</h1>
                <p>Order products from suppliers and track inventory receipts</p>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <textarea name="notes" id="notes" class="form-control" rows="3"
                                  placeholder="Any additional notes for this purchase order...">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
